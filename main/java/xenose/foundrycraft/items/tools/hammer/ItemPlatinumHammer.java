...
public class ItemPlatinumHammer extends FoundryHammer
{
	public ItemPlatinumHammer(String unlocalizedName, String registryName, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn, int harrvestArea) 
	{
