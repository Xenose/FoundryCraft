...
public class ItemUraniumHammer extends FoundryHammer
{
	...
	public ItemUraniumHammer(FoundryCraftItems foundryEnum, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn, int harrvestArea) 
	{
