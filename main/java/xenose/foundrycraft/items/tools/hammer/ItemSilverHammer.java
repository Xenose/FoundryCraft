...
public class ItemSilverHammer extends FoundryHammer
{

	public ItemSilverHammer(String unlocalizedName, String registryName, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn, int harrvestArea) 
	{
