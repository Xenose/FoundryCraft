...
public class ItemSilverHammer extends FoundryHammer
{
	...
	public ItemSilverHammer(FoundryCraftItems foundryEnum, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn, int harrvestArea) 
	{
