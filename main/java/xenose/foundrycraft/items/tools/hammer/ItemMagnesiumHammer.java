...
public class ItemMagnesiumHammer extends FoundryHammer  
{
	...
	public ItemMagnesiumHammer(FoundryCraftItems foundryEnum, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn, int harrvestArea) 
	{
