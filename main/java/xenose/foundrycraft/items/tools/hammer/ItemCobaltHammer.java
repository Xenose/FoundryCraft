...
public class ItemCobaltHammer extends FoundryHammer
{
	...
	public ItemCobaltHammer(FoundryCraftItems foundryEnum, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn, int harrvestArea) 
	{
