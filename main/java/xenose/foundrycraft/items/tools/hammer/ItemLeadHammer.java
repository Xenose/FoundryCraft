...
public class ItemLeadHammer extends FoundryHammer
{
	...
	public ItemLeadHammer(FoundryCraftItems foundryEnum, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn, int harrvestArea) 
	{
