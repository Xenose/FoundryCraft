...
public class ItemLithiumHammer extends FoundryHammer
{
	...
	public ItemLithiumHammer(FoundryCraftItems foundryEnum, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn, int harrvestArea) 
	{
