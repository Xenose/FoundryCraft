...
public class ItemLeadShovel extends FoundryShovel
{

	public ItemLeadShovel(String unlocalizedName, String registryName, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
