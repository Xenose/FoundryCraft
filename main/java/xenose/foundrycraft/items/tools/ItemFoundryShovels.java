...
public class ItemFoundryShovels extends FoundryShovel
{
	public ItemFoundryShovels(FoundryCraftItems foundryEnum, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
