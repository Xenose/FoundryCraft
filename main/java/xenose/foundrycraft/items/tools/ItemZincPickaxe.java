...
public class ItemZincPickaxe extends FoundryPickaxe
{

	public ItemZincPickaxe(String unlocalizedName, String registryName, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
