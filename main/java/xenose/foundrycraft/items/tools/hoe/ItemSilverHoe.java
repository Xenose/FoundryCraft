...
public class ItemSilverHoe extends FoundryTool
{
	public ItemSilverHoe(String unlocalizedName, String registryName, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
