...
public class ItemLithiumHoe extends FoundryTool
{
	public ItemLithiumHoe(String unlocalizedName, String registryName, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
