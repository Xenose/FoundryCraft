...
public class ItemLeadHoe extends FoundryHoe
{
	public ItemLeadHoe(FoundryCraftItems foundryEnum, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
