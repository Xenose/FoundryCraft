...
public class ItemUraniumHoe extends FoundryHoe
{
	public ItemUraniumHoe(FoundryCraftItems foundryEnum, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
