...
public class ItemTitaniumHoe extends FoundryTool
{
	public ItemTitaniumHoe(String unlocalizedName, String registryName, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
