...
public class ItemCobaltShovel extends FoundryShovel 
{

	public ItemCobaltShovel(String unlocalizedName, String registryName, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
