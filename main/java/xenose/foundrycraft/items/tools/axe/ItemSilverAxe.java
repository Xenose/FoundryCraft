...
public class ItemSilverAxe extends FoundryTool
{
	public ItemSilverAxe(String unlocalizedName, String registryName, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
