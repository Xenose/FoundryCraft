...
public class ItemCobaltAxe extends FoundryAxe
{
	public ItemCobaltAxe(FoundryCraftItems foundryEnum, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
