...
public class ItemTungstenPickaxe extends FoundryPickaxe
{
	
	public ItemTungstenPickaxe(String unlocalizedName, String registryName, float attackDamageIn, float attackSpeedIn, ToolMaterial materialIn, Set<Block> effectiveBlocksIn) 
	{
